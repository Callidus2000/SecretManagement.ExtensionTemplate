...
Remove-Module SecretManagement.ExtensionTemplate -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\SecretManagement.ExtensionTemplate.psd1"
Import-Module "$PSScriptRoot\..\SecretManagement.ExtensionTemplate.psm1" -Force
