...
There should be only one format file and one type extension file per project, as importing them has a notable impact on import times.
 ...
 - The Format XML should be named `SecretManagement.ExtensionTemplate.Format.ps1xml`
 - The Type Extension XML should be named `SecretManagement.ExtensionTemplate.Types.ps1xml`
